namespace Travel.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Travel.Models.DbEntity>
    {
        ...
        protected override void Seed(DbEntity context)
        {
            ...
            context.Languages.AddOrUpdate(new Language { LangID = 1, Name = "Հայերեն", CommonName = "Հայ", Locale = "hy", LangCulture="hy-AM" });
            context.Languages.AddOrUpdate(new Language { LangID = 2, Name = "English", CommonName = "Eng", Locale = "en",  LangCulture="en-US" });
            ...
            context.Settings.Add(new Settings { PageSize = 30, PhoneNumbers = "099999999", Email = "info@chilli.travel" });
